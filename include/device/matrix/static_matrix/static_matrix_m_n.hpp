...
#ifndef _STATIC_MATRIX_M_N_HPP_INCLUDED_SDPOINSAFDLKJN4E9UAHFLKJH498YHAFUH4389H 
#define _STATIC_MATRIX_M_N_HPP_INCLUDED_SDPOINSAFDLKJN4E9UAHFLKJH498YHAFUH4389H 
...
template<typename Type, device::size_t Row, device::size_t Col>
class static_matrix
{
public:
...
private:
    ...
    template<typename U>
    void do_copy(const static_matrix<U, Row, Col>& rhs)
    {
...
public:
    const static_matrix<value_type, Col, Row> operator~() const
    {
        return transpose();
    }
...
#endif//_STATIC_MATRIX_M_N_HPP_INCLUDED_SDPOINSAFDLKJN4E9UAHFLKJH498YHAFUH4389H 
