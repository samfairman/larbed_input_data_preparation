#ifndef _STATIC_MATRIX_2_2_HPP_INCLUDED_SDPOINSAFDLKJN4E9UAHFLKJH498YHAFUH4389H 
#define _STATIC_MATRIX_2_2_HPP_INCLUDED_SDPOINSAFDLKJN4E9UAHFLKJH498YHAFUH4389H 
...
public:
    ...
    typedef static_matrix_stride_iterator<value_type*, 2>               col_type;
    typedef static_matrix_stride_iterator<const value_type*, 2>         const_col_type;
    typedef static_matrix_stride_iterator<value_type*, 2+1>             diag_type;
    typedef static_matrix_stride_iterator<const value_type*, 2+1>       const_diag_type;
    typedef static_matrix_buffer<value_type, 2*2>                       storage_type;
...
public:
    ...
    template<typename U>
    static_matrix(const static_matrix<U, 2, 2>& rhs)
    {
        operator=<U>(rhs);
    }
    ...
    template<typename U>
    self_type &
    operator=(const static_matrix<U, 2, 2>& rhs)
    {
        do_copy<U>(rhs);
        return *this;
    }
...
private:
    ...
    template<typename U>
    void do_copy(const static_matrix<U, 2, 2>& rhs)
    {
...
public:
    ...
    {
        return diag_type(begin() + index * 2);
    }
    ...
    {
        return const_diag_type(begin() + index * 2);
    }
...
public:
    const static_matrix<value_type, 2, 2> operator~() const
    {
        return transpose();
    }
...
public:
    ...
    const static_matrix<value_type, 2, 2>
    transpose() const
    {
        static_matrix<value_type, 2, 2> ans;
...
public:
    ...
    const self_type inverse() const 
    {
        ...
        ans[0][1] = -ans[0][1];
        ans[1][0] = -ans[1][0];
        value_type const v = ans[0][0]*ans[1][1] - ans[1][0]*ans[0][1];
        return ans / v;
    }
...
#endif//_STATIC_MATRIX_2_2_HPP_INCLUDED_SDPOINSAFDLKJN4E9UAHFLKJH498YHAFUH4389H 
