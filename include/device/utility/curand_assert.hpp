#ifndef JRYSEGSVAIFYLYACLNJGXJDMRYMGHIXTNTQQJEMGIJFFLWFUDLATIJHOEFBMWOISAUTGMCWPK
#define JRYSEGSVAIFYLYACLNJGXJDMRYMGHIXTNTQQJEMGIJFFLWFUDLATIJHOEFBMWOISAUTGMCWPK
...
struct curand_result_assert
{
    ...
    {
        if ( result == CURAND_STATUS_VERSION_MISMATCH ) { return "CURAND: Header _le and linked library version do not match."; }
        ...
        if ( result == CURAND_STATUS_LENGTH_NOT_MULTIPLE ) { return "CURAND: Length requested is not a multple of dimension."; }
...
#endif//JRYSEGSVAIFYLYACLNJGXJDMRYMGHIXTNTQQJEMGIJFFLWFUDLATIJHOEFBMWOISAUTGMCWPK
